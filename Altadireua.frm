...
Begin VB.Form AltaClien 
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VB.Image Image9 
         Height          =   870
         Left            =   120
         MouseIcon       =   "Altadireua.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "Altadireua.frx":030A
         Top             =   120
         Width           =   720
      End
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.Image Image8 
         Height          =   720
         Left            =   120
         MouseIcon       =   "Altadireua.frx":23EC
         MousePointer    =   99  'Custom
         Picture         =   "Altadireua.frx":26F6
         Top             =   240
         Width           =   675
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "Altadireua.frx":40B8
      ...
      Tab(0).Control(18)=   "Text1(12)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "Text1(15)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "Text1(18)"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "Combo5"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).ControlCount=   22
      TabCaption(1)   =   "Dirección"
      TabPicture(1)   =   "Altadireua.frx":40D4
      ...
      Tab(1).Control(16)=   "Text1(13)"
      Tab(1).Control(17)=   "Text1(11)"
      Tab(1).Control(18)=   "Text1(10)"
      Tab(1).Control(19)=   "Text1(9)"
      Tab(1).Control(20)=   "Text1(7)"
      Tab(1).ControlCount=   21
      TabCaption(2)   =   "Credito"
      TabPicture(2)   =   "Altadireua.frx":40F0
      ...
      Tab(2).Control(5)=   "Combo2"
      Tab(2).Control(6)=   "Combo1"
      Tab(2).Control(7)=   "Text1(16)"
      Tab(2).Control(8)=   "Text1(23)"
    ...
    If Guar = "1" Then
        If Text1(0).Text = "" Then
            ...
            If VarMen.Text1(57).Text = "S" Then
                ...
                sBuscar = sBuscar & Text1(10).Text & "', '" & Text1(11).Text & "', '" & Text1(15).Text & "', '" & Text1(8).Text & "', '" & Text1(12).Text & "', '" & Text1(1).Text & "', '" & Text1(2).Text & "', '" & Text1(3).Text & "', '" & Text1(4).Text & "', '" & Text1(5).Text & "', '" & Text1(18).Text & "', '" & Combo3.Text & "', '" & Text1(14).Text & "', '" & Text1(13).Text & "', '" & Text1(9).Text & "', '" & Text1(7).Text & "', '" & Text1(20).Text & "', '" & Text1(19).Text & "', '" & Text1(17).Text & "', '" & VarMen.Text1(0).Text & "', " & Text1(16).Text & ", '" & Combo1.Text & "', " & ValDes & ", '" & Format(Date, "dd/mm/yyyy") & "', '" & Text1(23).Text & "', '" & MostLey & "', '" & Combo4.Text & "', 'A','" & Combo5.Text & "', 'S');"
            Else
                sBuscar = "INSERT INTO CLIENTE (CP, DIRECCION, NOMBRE, CONTACTO, CURP, NOMBRE_COMERCIAL, RFC, TELEFONO_CASA, TELEFONO_TRABAJO, FAX, WEB_PASSWORD, COLONIA, NUMERO_INTERIOR, NUMERO_EXTERIOR, CIUDAD, ESTADO, PAIS, DIRECCION_ENVIO, EMAIL, ID_AGENTE, FECHA_ALTA, COMENTARIOS, LEYENDAS, VALORACION,AGENTE,ASIG) VALUES ('"
                sBuscar = sBuscar & Text1(10).Text & "', '" & Text1(11).Text & "', '" & Text1(15).Text & "', '" & Text1(8).Text & "', '" & Text1(12).Text & "', '" & Text1(1).Text & "', '" & Text1(2).Text & "', '" & Text1(3).Text & "', '" & Text1(4).Text & "', '" & Text1(5).Text & "', '" & Text1(18).Text & "', '" & Combo3.Text & "', '" & Text1(14).Text & "', '" & Text1(13).Text & "', '" & Text1(9).Text & "', '" & Text1(7).Text & "', '" & Text1(20).Text & "', '" & Text1(19).Text & "', '" & Text1(17).Text & "', '" & VarMen.Text1(0).Text & "', '" & Format(Date, "dd/mm/yyyy") & "', '" & Text1(23).Text & "', 'S', 'A','" & Combo5.Text & "', 'S');"
            End If
            cnn.Execute (sBuscar)
            Text1(15).Text = ""
            Text1(12).Text = ""
...
On Error GoTo ManejaError
    ...
    Else
        ...
        Combo2.Locked = False
    End If
    If Combo3.Text <> "" And Text1(9).Text <> "" And Text1(11).Text <> "" And Text1(13).Text <> "" And Text1(15).Text <> "" Then
        Guar = "1"
    Else
        Guar = "0"
    End If
...
Private Sub Combo5_DropDown()
    ...
    sBuscar = "SELECT NOMBRE FROM USUARIOS  WHERE PUESTO='VENTAS' ORDER BY NOMBRE"
    Set tRs = cnn.Execute(sBuscar)
