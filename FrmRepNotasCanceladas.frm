...
Begin VB.Form FrmRepNotasCanceladas 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Reporte de notas canceladas por periodo"
   ClientHeight    =   2655
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7935
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VB.Image Image9 
         Height          =   870
         Left            =   120
         MouseIcon       =   "FrmRepNotasCanceladas.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "FrmRepNotasCanceladas.frx":030A
         Top             =   120
         Width           =   720
      End
   ...
   Begin VB.Frame Frame28 
      ...
      Begin VB.Image Image26 
         Height          =   855
         Left            =   120
         MouseIcon       =   "FrmRepNotasCanceladas.frx":23EC
         MousePointer    =   99  'Custom
         Picture         =   "FrmRepNotasCanceladas.frx":26F6
         Top             =   120
         Width           =   735
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      BackColor       =   16777215
      TabCaption(0)   =   " "
      TabPicture(0)   =   "FrmRepNotasCanceladas.frx":2C85
   ...
   End
End
Attribute VB_Name = "FrmRepNotasCanceladas"
...
Private Sub Image26_Click()
    ...
    sBuscar = "SELECT ID_VENTA, NOMBRE, SUBTOTAL, IVA, TOTAL, SUCURSAL FROM VENTAS WHERE FACTURADO = 2 AND FECHA BETWEEN '" & DTPicker1.Value & "' AND '" & DTPicker2.Value & "' ORDER BY ID_VENTA"
    ...
    If Not (tRs.EOF And tRs.BOF) Then
        ...
        oDoc.WTextBox 100, 205, 100, 175, "REPORTE DE VENTAS CANCELADAS", "F3", 8, hCenter
        Posi = 120
        oDoc.WTextBox Posi, 10, 20, 60, "Venta", "F2", 8, hCenter
        oDoc.WTextBox Posi, 65, 20, 70, "Sucursal", "F2", 8, hCenter
        oDoc.WTextBox Posi, 135, 20, 270, "Cliente", "F2", 8, hCenter
        oDoc.WTextBox Posi, 405, 20, 55, "Subtotal", "F2", 8, hCenter
        oDoc.WTextBox Posi, 460, 20, 55, "IVA", "F2", 8, hCenter
        oDoc.WTextBox Posi, 515, 20, 55, "Total", "F2", 8, hCenter
        Posi = Posi + 12
        ' Linea
        ...
        Do While Not tRs.EOF
            oDoc.WTextBox Posi, 10, 20, 60, tRs.Fields("ID_VENTA"), "F3", 7, hLeft
            oDoc.WTextBox Posi, 65, 20, 70, tRs.Fields("SUCURSAL"), "F3", 7, hLeft
            oDoc.WTextBox Posi, 135, 20, 300, tRs.Fields("NOMBRE"), "F3", 7, hLeft
            oDoc.WTextBox Posi, 405, 20, 55, Format(tRs.Fields("SUBTOTAL"), "###,###,##0.00"), "F3", 7, hRight
            oDoc.WTextBox Posi, 460, 20, 55, Format(tRs.Fields("IVA"), "###,###,##0.00"), "F3", 7, hRight
            oDoc.WTextBox Posi, 515, 20, 55, Format(tRs.Fields("TOTAL"), "###,###,##0.00"), "F3", 7, hRight
            Posi = Posi + 12
            If Posi >= 650 Then
                oDoc.NewPage A4_Vertical
                oDoc.WImage 70, 40, 43, 161, "Logo"
