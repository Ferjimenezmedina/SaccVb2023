...
Begin VB.Form FrmRepEntradasRapidas 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Reporte de entradas de Ordenes Rapidas"
   ClientHeight    =   2685
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7935
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VB.Image Image9 
         Height          =   870
         Left            =   120
         MouseIcon       =   "FrmRepEntradasRapidas.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "FrmRepEntradasRapidas.frx":030A
         Top             =   120
         Width           =   720
      End
   ...
   Begin VB.Frame Frame28 
      ...
      Begin VB.Image Image26 
         Height          =   855
         Left            =   120
         MouseIcon       =   "FrmRepEntradasRapidas.frx":23EC
         MousePointer    =   99  'Custom
         Picture         =   "FrmRepEntradasRapidas.frx":26F6
         Top             =   120
         Width           =   735
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      BackColor       =   16777215
      TabCaption(0)   =   " "
      TabPicture(0)   =   "FrmRepEntradasRapidas.frx":2C85
   ...
   End
End
Attribute VB_Name = "FrmRepEntradasRapidas"
...
Private Sub Image26_Click()
    ...
    sBuscar = "SELECT ORDEN_RAPIDA.FECHA, ORDEN_RAPIDA.ID_ORDEN_RAPIDA, PROVEEDOR_CONSUMO.NOMBRE, ORDEN_RAPIDA_DETALLE.ID_PRODUCTO , ORDEN_RAPIDA_DETALLE.CANTIDAD, ORDEN_RAPIDA_DETALLE.CAN_RECIBIDA FROM ORDEN_RAPIDA INNER JOIN ORDEN_RAPIDA_DETALLE ON ORDEN_RAPIDA.ID_ORDEN_RAPIDA = ORDEN_RAPIDA_DETALLE.ID_ORDEN_RAPIDA INNER JOIN PROVEEDOR_CONSUMO ON ORDEN_RAPIDA.ID_PROVEEDOR = PROVEEDOR_CONSUMO.ID_PROVEEDOR WHERE (ORDEN_RAPIDA_DETALLE.SURTIDO = 'S') AND (ORDEN_RAPIDA.FECHA BETWEEN '" & DTPicker1.Value & "' AND '" & DTPicker2.Value & "')"
    ...
    If Not (tRs.EOF And tRs.BOF) Then
        ...
        Do While Not tRs.EOF
            ...
            oDoc.WTextBox Posi, 65, 20, 70, tRs.Fields("ID_ORDEN_RAPIDA"), "F3", 7, hLeft
            oDoc.WTextBox Posi, 135, 20, 230, tRs.Fields("NOMBRE"), "F3", 7, hLeft
            oDoc.WTextBox Posi, 355, 20, 95, tRs.Fields("ID_PRODUCTO"), "F3", 7, hLeft
            oDoc.WTextBox Posi, 460, 20, 55, tRs.Fields("CAN_RECIBIDA"), "F3", 7, hRight
            oDoc.WTextBox Posi, 515, 20, 55, tRs.Fields("CANTIDAD"), "F3", 7, hRight
            Posi = Posi + 12
            If Posi >= 650 Then
                oDoc.NewPage A4_Vertical
                oDoc.WImage 70, 40, 43, 161, "Logo"
