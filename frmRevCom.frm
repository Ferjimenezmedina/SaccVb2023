...
Begin VB.Form frmRevCom 
   ...
   Begin VB.Label Label7 
      Caption         =   "5)  Escriba aquì la cantidad que no llego."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Caption         =   "3)  Si llego completo de click en LISTO"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label5 
      Caption         =   "4)  Seleccione el que llego incompleto."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Sub ENVIAR_COMANDA()
    ...
    If Val(Me.txtNoCom.Text) = 0 Then
        cComanda = Val(InputBox("¿CUAL ES EL NUMERO DE LA COMANDA?", "REVICIÓN DE COMANDAS"))
    Else
