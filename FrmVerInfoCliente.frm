...
Begin VB.Form FrmVerInfoCliente 
   BackColor       =   &H00FFFFFF&
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VB.Image Image9 
         Height          =   870
         Left            =   120
         MouseIcon       =   "FrmVerInfoCliente.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "FrmVerInfoCliente.frx":030A
         Top             =   120
         Width           =   720
      End
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   375
      Left            =   3000
      Picture         =   "FrmVerInfoCliente.frx":23EC
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   240
      Width           =   1215
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmVerInfoCliente.frx":4DBE
      ...
      TabPicture(1)   =   "FrmVerInfoCliente.frx":4DDA
      ...
      TabPicture(2)   =   "FrmVerInfoCliente.frx":4DF6
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Combo4"
      ...
      Begin VB.CommandButton COLONIA 
         ...
         Height          =   375
         Left            =   -72000
         Picture         =   "FrmVerInfoCliente.frx":4E12
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   960
         Width           =   1455
   ...
   End
End
Attribute VB_Name = "FrmVerInfoCliente"
